...
let
  ...
  # The greeter's picker labels come from `noctalia-greeter sessions`, which
  # reads the Name= of each installed wayland-session .desktop file.
  sessionLabel = {
    niri = "Niri";
    mango = "Mango";
  }.${config.khizar.desktop.default};
in
{
  imports = [ inputs.noctalia-greeter.nixosModules.default ];

  options.khizar.features.noctaliaGreeter.enable =
